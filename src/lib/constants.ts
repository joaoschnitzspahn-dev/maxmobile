...
/** Planos oficiais MAX MOBILE — tabela comercial (mensal + anual). */
export const PLANS = [
  {
    name: "Essencial",
    internet: "11 GB",
    internetDetail: "6 GB do plano + 5 GB portabilidade",
    portabilityBonus: "11 GB no total com portabilidade",
    minutes: "Ilimitados*",
    sms: "60 SMS",
    price: "49,90",
    annualPrice: "33,27",
  ...
  },
  {
    name: "Plus",
    internet: "15 GB",
    internetDetail: "10 GB do plano + 5 GB portabilidade",
    portabilityBonus: "15 GB no total com portabilidade",
    minutes: "Ilimitados*",
    sms: "100 SMS",
    price: "54,90",
    annualPrice: "36,60",
  ...
  },
  {
    name: "Pro",
    internet: "20 GB",
    internetDetail: "15 GB do plano + 5 GB portabilidade",
    portabilityBonus: "20 GB no total com portabilidade",
    minutes: "Ilimitados*",
    sms: "100 SMS",
    price: "64,90",
    annualPrice: "43,27",
  ...
  },
  {
    name: "Ultra",
    internet: "28 GB",
    internetDetail: "23 GB do plano + 5 GB portabilidade",
    portabilityBonus: "28 GB no total com portabilidade",
    minutes: "Ilimitados*",
    sms: "100 SMS",
    price: "74,90",
    annualPrice: "49,94",
  ...
  },
  {
    name: "Max",
    internet: "50 GB",
    internetDetail: "45 GB do plano + 5 GB portabilidade",
    portabilityBonus: "50 GB no total com portabilidade",
    minutes: "Ilimitados*",
    sms: "100 SMS",
    price: "94,90",
    annualPrice: "63,27",
...
export const WHY_US = [
  ...
  },
  {
    ...
    title: "Preço justo",
    description:
      "Planos a partir de R$ 49,90, sem fidelidade e com benefícios claros.",
  },
] as const;
